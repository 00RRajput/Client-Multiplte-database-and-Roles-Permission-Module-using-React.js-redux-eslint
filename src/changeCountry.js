...
const {  } = require("");
const Country = sourceDB.model("City", citySchema); // Replace with your source schema and model
const CountryDest = destinationDB.model("City", citySchema); // Replace with your destination schema and model
