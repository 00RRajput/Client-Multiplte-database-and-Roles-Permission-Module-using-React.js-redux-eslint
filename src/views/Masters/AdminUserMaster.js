...
import CreateUser from '../forms/user/createAdminUser';
import UpdateUser from '../forms/user/updateAdminUser';
    ...
    const handleAction = (action, data) => {
        switch (action) {
            case 'edit':
                ...
                break;
            case 'configuration':
                navigate(`/yms/role-permissions/${data.client_id}`);
                break;
            default:
                setComponent(false);
                setEditComponent(false);
            ...
            secondary={
                <Grid item sm={3} justifycontent="space-between">
                    {!component && !editComponent ? (
                        <PermissionGuard access="create_admin_user">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left">
                                            {/* {row?.role?.role.map((item) => (
                                                <Chip label={item ? changeRole(item) : ''} chipcolor="secondary" />
                                            ))} */}
                                            Admin
                                        </TableCell>
                                        <TableCell align="left" sx={{ pr: 3 }}>
                                            <PermissionGuard access="delete_admin_user">
                                                <Switch
                                            ...
                                            <PermissionGuard access="edit_admin_user">
                                                <IconButton
                                                    color="secondary"
                                                    size="small"
                                                    aria-label="edit"
                                            ...
                                            <IconButton
                                                ...
                                                size="small"
                                                aria-label="edit"
                                                data-id={row.client_code}
                                                onClick={() => handleAction('configuration', row)}
                                            >
                                                <PermDataSettingIcon sx={{ fontSize: '1.3rem' }} />
                                            </IconButton>
                                        </TableCell>
                                    </TableRow>
                                );
