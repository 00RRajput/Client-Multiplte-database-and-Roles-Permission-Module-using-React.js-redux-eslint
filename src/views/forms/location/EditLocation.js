...
function CreateProduct() {
    ...
    const values = locations.filter((item) => item.id === params.id);
    console.log('va;es', values);
    ...
    const formik = useFormik({
        initialValues: {
            ...
            clinet_name: values[0].client_name,
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            if (values) {
                ...
                try {
                    setOpen(true);
                    await axios.put(`/location/${params.id}`, formik.values);
                    resetForm();
                    dispatch(
                        openSnackbar({
                            open: true,
                        ...
                        <Grid item xs={12} md={3}>
                            <Stack>
                                ...
                                <Select
                                    ...
                                    value={formik.values.client || 'Select Country'}
                                    onChange={formik.handleChange}
                                    // onClick={countrydata}
                                >
                        ...
                        <Grid item xs={12} md={3}>
                            <Stack>
                                ...
                                <Select
                                    ...
                                    value={formik.values.state || 'Select State'}
                                    onChange={formik.handleChange}
                                >
                                    <MenuItem value="" disabled>
                                        Select State
