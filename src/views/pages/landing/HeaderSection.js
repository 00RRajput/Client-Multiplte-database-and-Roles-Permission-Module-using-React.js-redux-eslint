...
import { Box, Button, CardMedia, Container, Grid, Link, Stack, Typography, Toolbar } from '@mui/material';
        ...
        <>
            <Container sx={{ height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <Grid
                    ...
                    alignItems="center"
                    sx={{ mt: { xs: 11, sm: 1, md: 18.75 }, mb: { xs: 2.5, md: 10 } }}
                >
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    <Stack spacing={1}>
                                        ...
                                        Use FPS to Power Your
                                    </Typography> */}

                                        <Typography textAlign={{ xs: 'center', md: 'left' }} variant="h2" color="primary" sx={headerSX}>
                                            E-Logistics
                                        </Typography>
                                        <Typography
                    ...
                    <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
                        <Box sx={{ position: 'relative', zIndex: 9 }}>
                            <HeaderImage src="https://beta.coderootz.com/img/warehouse.gif" alt="Berry" />
                            {/* <Box
                            sx={{
                                position: 'absolute',
                                top: { md: -35, lg: -110 },
